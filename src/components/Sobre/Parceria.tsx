export default function Parceria() {
  return (
    <div className="w-full max-w-5xl bg-[var(--g1)] border-[0.2rem] border-[var(--g3)] rounded-3xl p-6 lg:p-8 mt-12">
      
      <h3 className="font-bold text-[var(--text-bold)] text-xl mb-5">
        Parceria com a{' '}
        <em
      ...
      <p className="font-bold text-[var(--text-main)] leading-relaxed">
