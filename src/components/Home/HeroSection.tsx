  ...
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 pt-12 pb-12 lg:pt-28 lg:pb-32 px-6 text-center">
      ...
      <div className="flex flex-col items-center">
        <h2 className="flex flex-col items-center text-[var(--g4)] text-[3rem] lg:text-[5rem] leading-tight">
          Seu jardim virtual,{' '}
          <em
...
>
  impacto real
        ...
        <p className="text-[var(--text-main)] pt-4 lg:pt-12 text-[1.2rem] lg:text-[1.75rem] max-w-[40rem]">
