![ARCGARDEN](src/assets/ArcGardenLogo.png)
...
### SITE
No front-end do projeto foram utilizados React para estrutura do projeto, Tailwind CSS pra estilização e Typescript para programação
...
- src/assets: contém os arquivos de imagens e afins
- src/components: contém os elementos do site
- src/pages: contém as páginas do site
- src/layours: contém o layout padrão das páginas
...
### Franco Marquina - 1TDSPK - RM572901
...
https://github.com/HayanoIche/ArcGarden-FrontEnd
